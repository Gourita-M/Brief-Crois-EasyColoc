...
class UserDashboardController extends Controller
{
    public function userIndex()
    {
        ...
        if ($membership) {
            ...
            return View('owner.userdashboard', Compact('accommodationinfo', 'members', 'expenses', 'sum', 'person', 'categories', 'balance'));
        } else {
            $expenses = null;
            $members = null;
            ...
            return View('owner.userdashboard', Compact('accommodationinfo', 'members', 'expenses', 'sum', 'categories', 'balance'));
        }
    }
}
